...
import { DropdownItem } from './audience-dropdown-item.component';
...
export function AudienceDropdown(props: Props) {
	...
	return (
		<div
			className={`${props.position || 'right-[-4px] top-11'} px-[8px] py-[16px] absolute w-50 my-[2px] z-10 bg-gray-460 rounded-[8px] shadow-lg focus:outline-none ${isOpened ? '' : 'hidden'}`}
			ref={element}
			data-open={isOpened}
		>
